  ...
  const fetchLatestTickets = async () => {
    try {
      ...
      if (selectedStatus === 'NOT_ACTIVE') {
        ...
        url = `https://techaid-001-site1.ptempurl.com/api/ticket/Ticket/filter_for_admin?status=NOT_ACTIVE&filter=${filter}`;
      } else {
        // Default URL for all other statuses
        url = `https://techaid-001-site1.ptempurl.com/api/ticket/Ticket/filter?filter=${filter}`;
      }
