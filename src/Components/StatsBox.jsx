...
const StatsBox = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://techaid-001-site1.ptempurl.com/api/ticket/Ticket/get_all_ticket_count')
      .then((response) => {
    ...
    axios.get('https://techaid-001-site1.ptempurl.com/api/ticket/Ticket/get_completed_ticket_count')
      .then((response) => {
    ...
    axios.get('https://techaid-001-site1.ptempurl.com/api/ticket/Ticket/get_active_ticket_count')
      .then((response) => {
